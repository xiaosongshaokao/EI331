...
if __name__ == '__main__':
    ...
    train_model_path = os.path.join(cur_dir, r'carIdentityData\model\letter_recognize\model.ckpt')
    model_path = os.path.join(cur_dir, r'carIdentityData\model\letter_recognize')
